...
from src.analyzer import ( count_number_of_observations,find_hottest_day,
find_coldest_day,find_rainiest_day,find_windest_day,calculate_average_maximum_temperature,
calculate_average_minimum_temperature,calculate_average_rainfall,calculate_average_humidity ,
...
def main():
    ...
    maximum_temperature = calculate_average_maximum_temperature(records)
    minimum_temperature = calculate_average_minimum_temperature(records)
